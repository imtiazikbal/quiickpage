<div class="app-sidebar colored">
    <div class="sidebar-header">
        <a class="header-brand" href="{{route('dashboard')}}">
            <div class="logo-img">
               <img height="30" src="{{ asset('img/logo.svg')}}" class="header-brand-img" title="RADMIN"> 
            </div>
        </a>
    ...
    <div class="sidebar-content">
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div class="nav-item {{ ($segment1 == 'dashboard') ? 'active' : '' }}">
                    <a href="{{ route('categories') }}"><i class="ik ik-list"></i><span>{{ __('Categories')}}</span></a>
                    
                </div>
                <div class="nav-item {{ ($segment1 == 'dashboard') ? 'active' : '' }}">
                    <a href="{{ route('products') }}"><i class="ik ik-users"></i><span>{{ __('Services')}}</span></a>
