                       ...
                       @csrf
                        <div class="row pt-md-4">
                            <div class="col-md-8 px-sm-5">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <label for="colFormLabel"> {{ __('Range') }}</label>
                                        <input type="text" name="range" id="title" value="{{ $product->range }}" id="colFormLabel"
                                            class="form-control form-control-lg form_check_color_right" required>
                                    </div>
                                    @if ($errors->has('range'))
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        <label for="colFormLabel"> {{ __('Power By') }}</label>
                                        <input type="text" name="powerBy" id="title" value="{{ $product->powerBy }}" id="colFormLabel"
                                            class="form-control form-control-lg form_check_color_right" required>
                                    </div>
